  ...
  const { 
    ...
    onFunctionCall: (functionCall) => {
      if (functionCall.name === 'updateOrder') {
        const orderData = functionCall.parameters?.orderDetailsData || [];
        const total = orderData.reduce((sum: number, item: OrderItem) => 
          sum + (item.price * item.quantity), 0
        );
        setOrder({ items: orderData, total });
      }
    }
  });
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 shadow-2xl">
            <div className="text-center mb-6">
              ...
              <p className="text-white/80">Your AI Drive-Thru Assistant</p>
            </div>
              ...
              {!avatarReady ? (
                ...
                <div className="flex items-center justify-center h-full text-white">
                  <div className="text-center">
                    ...
                    <p className="text-lg">Avatar Ready!</p>
                  </div>
                </div>
              )}
            </div>
            ...
            <div className="text-center">
              ...
              {isSpeechActive && (
                <p className="text-white/80 text-sm">Escuchando...</p>
              )}
            </div>
          </div>
        ...
        {messages.length > 0 && (
          <div className="mt-8 bg-white/10 backdrop-blur-md rounded-2xl p-6 shadow-2xl">
            <h3 className="text-xl font-bold text-white mb-4">Conversación</h3>
